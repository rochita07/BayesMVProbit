...
nominal_post_beta(category = c(3,4), iter = 200, burn = 100, cred_level = 0.95, x_list, sig, d, prior_beta_mean = NULL, prior_beta_var = NULL)
...
ordinal_post_beta(category = c(4, 3), df_t = NULL, iter = 100,  burn = 10, cred_level = 0.95, x_list, sig = diag(2), y , prior_delta_mean = NULL, prior_delta_var = NULL, prior_beta_mean = NULL, prior_beta_var = NULL)
